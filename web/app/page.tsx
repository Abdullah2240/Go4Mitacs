...
export default function Home() {
  ...
  return <main className="shell">
    ...
    <div className="workspace-shell">
      ...
      {aiReviewOpen && <AIRequestReview documents={documents} provider={provider} model={model} action={aiAction} selectedIds={aiSelectedIds} onSelected={setAiSelectedIds} includePrivate={aiIncludePrivate} onIncludePrivate={setAiIncludePrivate} preview={aiPreview} onConfirm={confirmAIReviewSafe} onCancel={() => setAiReviewOpen(false)} busy={aiBusy} />}
